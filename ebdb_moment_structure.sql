...
--
-- Host: aa1snezwdmx5k8n.chvw0t2jxp57.us-east-1.rds.amazonaws.com:3306
...
--
-- Table structure for table `import_shipment_customer_6035`
--

CREATE TABLE `import_shipment_customer_6035` (
  `id` int UNSIGNED NOT NULL,
  `reference` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `weight` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `booking_mode` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `consingor_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `consinger_address` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `consinger_mobile` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `consinger_email` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parcel_description` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cod_amount` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shipment_value` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `piece_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `language_meta` (
  ...
  `lang_meta_content_id` int UNSIGNED NOT NULL,
...
CREATE TABLE `mail_templates` (
  ...
  `send_to` int NOT NULL COMMENT '"1" for staff , "2" for client and "3" for messanger',
  `status` int NOT NULL,
...
CREATE TABLE `members` (
  ...
  `sms_notify` tinyint DEFAULT '0' COMMENT '0:OFF , 1:On',
  ...
  `client_type` tinyint DEFAULT '1' COMMENT '1:C2C , 2:B2C',
  ...
  `messenger` tinyint DEFAULT '0' COMMENT '0:member , 1:messenger',
  `ajoul_alias` int DEFAULT NULL,
  `messenger_route_id` int DEFAULT NULL,
...
CREATE TABLE `sh_cod_shipments` (
  `id` int NOT NULL,
  `drs_id` int NOT NULL,
  `status` int NOT NULL DEFAULT '0' COMMENT '"1"=>confirm, "2"=>confirmed, "0" => not_available',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_coupons` (
  ...
  `type` int NOT NULL COMMENT '''one'' for fixed and ''two'' for percentage',
  `amount` varchar(100) DEFAULT NULL,
  `status` int NOT NULL,
  `num_of_use` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_drs` (
  ...
  `drs_city` int DEFAULT NULL,
  `status` int DEFAULT '1' COMMENT '"one"=>runing , "2"=>derlivered',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_invoices` (
  ...
  `total_amount_paid` tinyint DEFAULT '0',
  `cod_amount` double DEFAULT '0',
  `amount` double DEFAULT '0',
  `customer_amount` double DEFAULT '0',
  `customer_amount_paid` tinyint DEFAULT '0',
...
CREATE TABLE `sh_manifests` (
  ...
  `shipment_count` int DEFAULT NULL,
  `messenger_id` int DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `sh_pickup` (
  ...
  `driver_id` int DEFAULT NULL,
  `shipment_count` int NOT NULL,
  `status` int DEFAULT '1' COMMENT '("one"=>runing = pending)  , ("2"=>derlivered = done)',
  `flag` int NOT NULL DEFAULT '0' COMMENT ' 1->"confirm", "0" -> "not confirm"" ',
...
CREATE TABLE `sh_products` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `drop_of` int DEFAULT NULL,
  `coll_service` int DEFAULT NULL,
...
CREATE TABLE `sh_receivers` (
  ...
  `m_receiver_name` varchar(150) DEFAULT NULL,
  `receiver_country_id` int DEFAULT NULL,
  `receiver_city_id` int DEFAULT NULL,
...
CREATE TABLE `sh_senders` (
  ...
  `sender_country_id` int DEFAULT NULL,
  `sender_city_id` int DEFAULT NULL,
  `sender_zip` int DEFAULT NULL,
...
CREATE TABLE `sh_shipments` (
  ...
  `messenger_id` int DEFAULT NULL,
  `comment` text,
  `binlocation_id` int DEFAULT NULL,
  `customer_id` int DEFAULT NULL,
  `vendor_id` int DEFAULT '0',
...
CREATE TABLE `sh_shipments_branches_dummy` (
  ...
  `parcel_quantity` int DEFAULT NULL,
  `parcel_weight` double DEFAULT NULL,
  ...
  `schedule` tinyint DEFAULT '0',
  `schedule_date` date DEFAULT NULL,
  `pay_status` tinyint DEFAULT '0' COMMENT '0 is pending',
...
CREATE TABLE `sh_shipment_logs` (
  ...
  `main_status_id` int DEFAULT NULL,
...
CREATE TABLE `sh_zones` (
  ...
  `status` int NOT NULL,
  `type` int NOT NULL COMMENT 'one for world and two for city',
  `def_zone` tinyint DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `import_shipment_customer_6035`
--
ALTER TABLE `import_shipment_customer_6035`
  ADD PRIMARY KEY (`id`),
  ADD KEY `import_shipment_customer_6035_product_type_index` (`product_type`),
  ADD KEY `import_shipment_customer_6035_service_id_index` (`service_id`),
  ADD KEY `import_shipment_customer_6035_destination_index` (`destination`);
...
--
-- AUTO_INCREMENT for table `import_shipment_customer_6035`
--
ALTER TABLE `import_shipment_customer_6035`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `languages`
  MODIFY `lang_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `language_meta`
--
ALTER TABLE `language_meta`
  MODIFY `lang_meta_id` int UNSIGNED NOT NULL AUTO_INCREMENT;
